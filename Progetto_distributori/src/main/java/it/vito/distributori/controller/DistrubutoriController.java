package it.vito.distributori.controller;

import it.vito.distributori.model.DistributoreDTO;
import it.vito.distributori.model.Point;
import it.vito.distributori.model.db.Comune;
import it.vito.distributori.service.PointService;
...
public class DistrubutoriController {
    ...
    public ResponseEntity<List<DistributoreDTO>> getDistributori(@RequestParam("lant") double lant,
        ...
        try {
            ...
            List<DistributoreDTO> listaEmpty = new ArrayList<>();
            return (ResponseEntity<List<DistributoreDTO>>) new ResponseEntity(listaEmpty, HttpStatus.CONFLICT);
        }
